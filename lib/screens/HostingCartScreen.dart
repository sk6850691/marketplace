...
import 'package:marketplace/widgets/WebsitePlanWidget.dart';
...
class HostingCartScreen extends StatefulWidget {
  final description;
  final int  price;
  final cartItem;

  const HostingCartScreen({Key key,this.cartItem,this.description,this.price}) : super(key: key);

  @override
  _HostingCartScreenState createState() => _HostingCartScreenState();
}

class _HostingCartScreenState extends State<HostingCartScreen> {
                                      ...
                                      itemBuilder: (context,index){
                                        return GestureDetector(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              WebsitePlanWidget(appPlanModel: appProvider.hostingPlans[index],)
                                            ],),
                                        );
