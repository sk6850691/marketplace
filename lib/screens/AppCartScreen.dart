...
class AppCartScreen extends StatefulWidget {
  ...
  const AppCartScreen({Key key,this.cartItem,this.description,this.price}) : super(key: key);
                                      ...
                                      itemBuilder: (context,index){
                                        return GestureDetector(
                                          onTap: (){
                                            ...
                                            openCheckout(appProvider.appplans[index].price);
                                            Price = appProvider.appplans[index].price;
